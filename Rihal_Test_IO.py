...
import sys
 ...
 ''' 
Part #additional : inputing PDF path file to convert the second page
''' 

file_input= input('Enter the File Path to Convert the PDF:')
...
pages = convert_from_path(file_input, 300) 
...
''' 
Part #2 - Recognizing text from the images using OCR with writing a text file 
'''
...
''' 
Part #3 - Extractin text using REGEX 
'''
